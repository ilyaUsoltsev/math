...
import { Plus, X, Star, Trophy, Sparkles, RotateCcw, Minus, Percent, Baby, BookOpen, GraduationCap, Brain } from 'lucide-react';
...
function App() {
  ...
  const ageGroups: Record<AgeGroup, AgeGroupConfig> = {
    ...
    explorer: {
      ...
      description: 'Multiplication, division within 10, Addition/subtraction within 100',
      maxNumber: 100,
    ...
    apprentice: {
      ...
      description: 'Fractions, decimals, Multiplication/division within 100, Addition/subtraction within 1000',
      maxNumber: 1000,
      operations: ['addition', 'subtraction', 'multiplication', 'division'],
      color: 'bg-green-500'
    }
  ...
  const generateProblem = () => {
    ...
    const randomOperation = operationsArray[Math.floor(Math.random() * operationsArray.length)];
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-400 via-purple-500 to-pink-500 flex items-center justify-center p-4">
      <div className="bg-white rounded-3xl shadow-2xl p-8 max-w-lg w-full relative overflow-hidden">
        ...
        <div className="mb-6 relative z-10">
          <h3 className="text-lg font-semibold text-gray-700 mb-3 text-center">Choose Your Age Level</h3>
        ...
        <div className="grid grid-cols-2 gap-4 mb-6 relative z-10">
          ...
          {ageGroups[selectedAgeGroup].operations.includes('multiplication') && (
            <button
